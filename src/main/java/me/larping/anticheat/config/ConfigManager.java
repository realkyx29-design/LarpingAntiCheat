...
public final class ConfigManager {
    ...
    private static Snapshot build(FileConfiguration cfg) {
        ...
        return new Snapshot(
                ...
                cfg.getBoolean("setbacks.enabled", true),
                cfg.getLong("setbacks.cooldown-ms", 1200),
                cfg.getBoolean("enforcement.cancel-attacks", true),
                cfg.getBoolean("enforcement.cancel-blocks", true),
                cfg.getBoolean("enforcement.cancel-breaks", true),
                cfg.getBoolean("enforcement.correct-movement", true),
                cfg.getBoolean("enforcement.enforce-flight", true),
                cfg.getBoolean("enforcement.enforce-velocity", true),
